...
import { CheckCircle, XCircle, Clock, Calendar, Clock3, AlarmClock, Trash2 } from "lucide-react";
...
export const RequestCard = ({ request, onApprove, onReject, onDelete, showActions, isAdmin }: RequestCardProps) => {
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        title="Xóa yêu cầu"
        description="Bạn có chắc chắn muốn xóa yêu cầu này không? Hành động này không thể hoàn tác."
        confirmText="Xóa"
        cancelText="Hủy"
      />
    </>
